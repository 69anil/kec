...
shirt2.color = 'red';
console.log(shirt2); // { size: 'large', material: 'cotton', color: 'red' }
...
person4.age = 35;
console.log(person4); // { name: 'Alice', age: 35, city: 'New York' }
...
delete book5.price;
console.log(book5); // { title: 'The Great Gatsby', author: 'F. Scott Fitzgerald', year: 1925 }
...
console.log(employee6.department); // 'HR'
...
box7.size = 'large';
console.log(box7); // { type: 'box', dimensions: { length: 10, width: 8, height: 6 }, size: 'large' }
...
console.log(person8.firstName + ' ' + person8.lastName); // 'John Doe'
...
cart9.quantity += 1;
cart9.total += 15; // Assuming the price per item is 15
console.log(cart9); // { item: 'Book', quantity: 3, total: 45 }

// Q10: Check if the 'price' property in the 'product' object is less than 100.
// Expected output:
// false
const product10 = { name: 'Phone', price: 150 };
console.log(product10.price < 100); // false
